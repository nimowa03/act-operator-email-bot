...
2. Check cookiecutter template values (act name: Email Assistant, cast name: Email Bot)
...
**Condition**:
- Skip if: Cast name already provided by cookiecutter template (Email Bot)
...
```json
{
  "question": "I see you created a cast called 'Email Bot'. What should this cast accomplish?",
...
```json
{
  "question": "What is the main goal of Email Bot Cast?",
  "header": "Cast Goal",
  "options": [
