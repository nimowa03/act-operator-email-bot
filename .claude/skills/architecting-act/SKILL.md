...
# Architecting Email Assistant Act
...
**Steps:**
1. **Email Assistant Act Questions** → [modes/initial-design-questions.md](./resources/modes/initial-design-questions.md)
...
2. **Email Bot Cast Design** → Follow "Cast Design Workflow" below
3. **Generate CLAUDE.md files** → See "Generating CLAUDE.md" section below
   - Create `/CLAUDE.md` (Act info + Casts table)
   - Create `/casts/email-bot/CLAUDE.md` (Cast details)
...
**Steps:**
1. **Read CLAUDE.md** → Understand existing Email Assistant Act and Casts
